...
api_key = "c25952b7-cf21-4408-95c9-09d7e744f811"
secret_key = "FB4962602A9CF79263471D3D1DE6ABEF"
passphrase = "Jy388316"
...
channels = [{"channel": "tickers", "instId":"LTC-USDT-SWAP"}]
# 持仓总量频道 
...
if __name__=="__main__":
    ...
    loop.run_until_complete(subscribe_without_login(url=url,channels=channels))
    loop.close()
